<template>
  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="转换项目" min-width="160px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.title }}</span>
        </template>
      </el-table-column>
      <el-table-column label="转换前数量" min-width="150px" align="center">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.amount }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="转换后数量" min-width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.trans_amount }}</span>
        </template>
      </el-table-column>
      <el-table-column label="手续费" min-width="90px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.fee }}</span>
        </template>
      </el-table-column>
      <el-table-column label="转换时间" min-width="150px" align="center">
        <template slot-scope="scope">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.limit" @pagination="getTranslateList" />
...
<script>
import { getTranslateList } from '@/api/index'
...
export default {
  ...
  methods: {
    getTranslateList(){
      ...
      getTranslateList(this.listQuery).then(response => {
